 ...
 */
public class AdaptadorSolicitudesRecibidas extends RecyclerView.Adapter<AdaptadorSolicitudesRecibidas.SolicitudViewHolder> {

    private ArrayList<SolicitudDTO> datos;
    private static RecyclerViewClickListener recyclerViewClickListener;

    public AdaptadorSolicitudesRecibidas(ArrayList<SolicitudDTO> datos, RecyclerViewClickListener recyclerViewClickListener) {
        this.datos = datos;
    ...
    public SolicitudViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.lst_solicitudes_recibidas, parent, false);
    ...
    public static class SolicitudViewHolder
        ...
        public SolicitudViewHolder(View itemView) {
            ...
            emisor = (TextView) itemView.findViewById(R.id.nombreEmisorFragSolRec);
            receptor = (TextView) itemView.findViewById(R.id.nombreReceptorFragSolRec);
